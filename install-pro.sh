...
docker load -i ./setupfolder/artifactory-pro.tar
...
cp ./setupfolder/docker-compose-pro.yml ./docker-compose-pro.yml
sed -i "s/replaceHost/$1/gi" ./docker-compose-pro.yml
...
docker stack deploy -c docker-compose-pro.yml $1 
